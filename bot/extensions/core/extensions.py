...
from bot.utils import codeblock
...
class Extensions(Cog):
    ...
    async def load_extension(self, ctx: Context, extension: str) -> None:
    ...
    async def unload_extension(self, ctx: Context, extension: str) -> None:
